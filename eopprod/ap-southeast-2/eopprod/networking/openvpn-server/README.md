...
module](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.95.0/modules/mgmt/openvpn-server/openvpn-server.json).

See [the module docs](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.95.0/modules/mgmt/openvpn-server) for more
