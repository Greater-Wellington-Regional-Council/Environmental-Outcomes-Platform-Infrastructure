...
# ---------------------------------------------------------------------------------------------------------------------
locals {
  tls_secrets_manager_arn = "arn:aws:secretsmanager:ap-southeast-2:422253851608:secret:SampleAppBackEndCA-jn57ir"
  db_secrets_manager_arn  = "arn:aws:secretsmanager:ap-southeast-2:422253851608:secret:RDSDBConfig-ZgtELd"
