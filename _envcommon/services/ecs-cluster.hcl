...
inputs = {
  ...
  cluster_instance_ami_filters = {
    ...
    filters = [
      {
        name   = "name"
        values = ["ecs-cluster-instance-v0.95.0-*"]
      },
    ]
  }
  ...
  allow_ssh_from_security_group_ids = [dependency.network_bastion.outputs.bastion_host_security_group_id]
  ...
  # Enable Capacity Providers for ECS Cluster Autoscaling. Refer to https://github.com/gruntwork-io/terraform-aws-service-catalog/blob/main/modules/services/ecs-cluster/core-concepts.md#how-do-you-configure-cluster-autoscaling for more information.
