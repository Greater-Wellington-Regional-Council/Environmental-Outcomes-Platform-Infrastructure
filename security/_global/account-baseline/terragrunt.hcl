...
inputs = {
  ...
  cloudtrail_benchmark_alarm_sns_topic_kms_master_key_id = local.cloudtrail_kms_key_arn
  ...
  kms_grants = {
    ami_encryption_key = {
      kms_cmk_arn       = "arn:aws:kms:ap-southeast-2:898449181946:alias/ami-encryption"
